    ...
    return dbc.Row(
        dbc.Col(
            [
                ...
                dbc.FormGroup(
                    [
                        dbc.FormText('Enter First Name'),
                        dbc.Input(id='register-first',autoFocus=True),
                        html.Br(),

                        dbc.FormText('Enter your Last Name'),
                        dbc.Input(id='register-last'),
                        html.Br(),
                        
                        dbc.FormText('Enter your Email',id='register-email-formtext',color='secondary'),
                        dbc.Input(id='register-email'),
                        html.Br(),
                        
                        dbc.FormText('Enter your Password'),
                        dbc.Input(id='register-password',type='password'),
                        html.Br(),
                        
                        dbc.FormText('Please Confirm password'),
                        dbc.Input(id='register-confirm',type='password'),
                        html.Br(),
                        

                        dbc.Button('Register',color='success',id='register-button'),
                    ]
                )
            ],
            width=6
...
# este callback valida la informacion ingresada por del usuario
@app.callback(
...
# este callback se encarga de post procesar el registro
@app.callback(
